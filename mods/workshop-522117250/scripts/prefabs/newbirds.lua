...
local function makebird(name, soundname)
    ...
    local function fn()
        ...
        if name == "bluer" then
            inst.components.lootdropper:AddRandomLoot("feather_robin_winter", .5)
        elseif name == "robgr" then
            inst.components.lootdropper:AddRandomLoot("feather_crow", .5)
        elseif name == "robye" then
            inst.components.lootdropper:AddRandomLoot("feather_robin", .5)
        elseif name == "tucan" then
            inst.components.lootdropper:AddRandomLoot("feather_robin", .5)
        end
