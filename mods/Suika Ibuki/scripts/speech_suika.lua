...
return {
	ACTIONFAIL =
	{
        ...
        GIVETOPLAYER = 
        {
        	FULL = "They're too tiny!",
            DEAD = "I'll just keep this.",
            SLEEPING = "Wake up!",
            BUSY = "Hurry up!",
    	},
    	GIVEALLTOPLAYER = 
	...
	ANNOUNCE_NORMALTOMIGHTY="Fired up!",
	ANNOUNCE_NORMALTOWIMPY="I'm sober!",
	ANNOUNCE_WIMPYTONORMAL="Another!",
	ANNOUNCE_MIGHTYTONORMAL="I'm starting to get sober...",
	...
	ANNOUNCE_CHARLIE = "Fight me!",
	ANNOUNCE_CHARLIE_ATTACK = "On second thought...",
	ANNOUNCE_COLD = "Get inside!",
	ANNOUNCE_HOT = "I need a cold drink.",
	ANNOUNCE_CRAFTING_FAIL = "I don't have all of the ingredients.",
	ANNOUNCE_DEERCLOPS = "A challenger approaches!",
	ANNOUNCE_DUSK = "We'll make this one an all-nighter.",
	ANNOUNCE_EAT =
	{
		GENERIC = "More!",
		PAINFUL = "I can take it!",
		SPOILED = "Disgusting!",
		STALE = "I hope nobody saw that.",
		INVALID = "That's inedible.",
		YUCKY = "That's not dessert...",
	},
	ANNOUNCE_ENTER_DARK = "That's no fun.",
	ANNOUNCE_ENTER_LIGHT = "Yay!",
	ANNOUNCE_FREEDOM = "I'm free!",
	ANNOUNCE_HIGHRESEARCH = "Divine power!",
	ANNOUNCE_HOUNDS = "Puppies!",
	ANNOUNCE_HUNGRY = "I need something.",
	ANNOUNCE_HUNT_BEAST_NEARBY = "I have you now!",
	ANNOUNCE_HUNT_LOST_TRAIL = "I can't find it.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "The wet ground won't hold a footprint.",
	ANNOUNCE_INV_FULL = "I'm not big enough.",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Filthy parasites!",
	...
	ANNOUNCE_NOSLEEPONFIRE = "Sleeping there seems like a bad idea.",
	...
	ANNOUNCE_PECKED = "Ow! You idiot!",
	ANNOUNCE_QUAKE = "That doesn't sound good.",
	ANNOUNCE_RESEARCH = "Never stop learning!",
	ANNOUNCE_SHELTER = "This is a great place to have a party!",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "Hot!",
	ANNOUNCE_TORCH_OUT = "Party's over...",
	...
	ANNOUNCE_TOOL_SLIP = "That tool is slippery!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Icicle Fall is harder to dodge than that.",

	ANNOUNCE_DAMP = "Woo!",
	ANNOUNCE_WET = "This is fun!",
	ANNOUNCE_WETTER = "Yay!",
	ANNOUNCE_SOAKED = "Pool party!",
	
	ANNOUNCE_BECOMEGHOST = "ooOOoooOOOoOooo!!",
	ANNOUNCE_GHOSTDRAIN = "Get back up you stupid ghost!",

	DESCRIBE_SAMECHARACTER = "Looking good!",
	
	BATTLECRY =
	{
		GENERIC = "Fight me coward!",
		PIG = "Now for the main dish!",
		PREY = "An appetizer!",
		SPIDER = "Squishy!",
		SPIDER_WARRIOR = "Die!",
	},
	COMBAT_QUIT =
	{
		...
		PREY = "Come back!",
		SPIDER = "That was fun.",
		SPIDER_WARRIOR = "That was fun!",
	},
	DESCRIBE =
	{
        PLAYER =
        {
            GENERIC = "%s looks up for a party!",
            ATTACKER = "%s ruined someone's day.",
            MURDERER = "Murderer!",
            REVIVER = "%s, friend of ghosts.",
            GHOST = "%s had too much to drink.",
        },
		WILSON = 
		{
			GENERIC = "It's Wilson!",
		...
		MULTIPLAYER_PORTAL = "I could do better.",
		GLOMMER = "D'awww!",
		GLOMMERFLOWER = 
		{
		...
		MOLE =
		{
			HELD = "Nowhere left to dig!",
			UNDERGROUND = "Something's under there.",
			ABOVEGROUND = "I'd sure like to whack him!",
		},
