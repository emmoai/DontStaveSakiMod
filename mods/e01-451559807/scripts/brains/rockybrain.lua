...
-- Klei made a booboo here, "item" should be "inst" in all 3 cases, thank you Isosurface for noticing the bug.
    return inst.components.inventoryitem.canbepickedup and inst:GetTimeAlive() >= 8 and inst:IsOnValidGround()
end
