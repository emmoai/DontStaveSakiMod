...
local function applyupgrades(inst)
	...
	inst.components.sanity.max = math.ceil (70 + upgrades * 2) --130
	
	inst.components.locomotor.walkspeed =  math.ceil (7 + upgrades / 6) --13
	inst.components.locomotor.runspeed = math.ceil (9 + upgrades / 6) --15
