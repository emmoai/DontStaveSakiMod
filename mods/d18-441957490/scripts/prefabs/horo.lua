...
local function updatedamage(inst, phase)
	if phase == "day" then
		...
		inst.components.locomotor.runspeed = (TUNING.WILSON_WALK_SPEED * 2)
	...
	elseif phase == "dusk" then
		...
		inst.components.locomotor.runspeed = (TUNING.WILSON_WALK_SPEED * 3)
...
local master_postinit = function(inst)
	...
	-- Stats	
	inst.components.health:SetMaxHealth(9)
