...
-- Experimental Fix for some rare crashes. Comment in if needed.
...
-- Breaks combat with Monkey if "weaponrange.components.weapon.variedmodefn(weapon).hitrange)" is not set to "weapon.components.weapon.variedmodefn(weapon).hitrange)"
