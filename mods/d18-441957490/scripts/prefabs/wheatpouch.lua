...
local function onequip(inst, owner) 
    ...
    owner.components.health.maxhealth = 160
...
local function onunequip(inst, owner) 
	...
	owner.components.health.maxhealth = 9
    owner.components.health:DoDelta(0)
...
STRINGS.NAMES.WHEATPOUCH = "血量上限背包"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.WHEATPOUCH = "这个让我的生命又充满了意义."
