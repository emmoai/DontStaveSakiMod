...
STRINGS.CHARACTER_TITLES.horo = "贤狼赫萝"
STRINGS.CHARACTER_NAMES.horo = "Horo"
STRINGS.CHARACTER_DESCRIPTIONS.horo = "- 自带装备，装上血量上限140，缓慢回血\n-白天速度慢，黄昏加快，夜间最快,攻击力同上 \n-血量上限只有30"
STRINGS.CHARACTER_QUOTES.horo = "狼与香辛料的女主角"
GLOBAL.STRINGS.NAMES.WHEATPOUCH = "血上限背包"
